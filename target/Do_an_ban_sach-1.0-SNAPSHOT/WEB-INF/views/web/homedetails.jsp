            ...
            <div class="col-sm-3 col-xs-6">
                <div class="col-left">
                    ...
                    <div class="special">
                        ...
                        <c:forEach var="item" items="${homeResponse.findByTopDiscount}">
                            <ul class="unliststyle special-content">
                                <li class="special-item">
                        ...
                        <div class="category-product">
                            <form action="<c:url value="/trang-chu/chi-tiet"/> " id="formSubmit" method="get">
                                ...
                                <div class="product-list" id="content1">
                                    <c:forEach var="item" items="${homeResponse.categories}">
...
<script>
    ...
    var queryStringValue = "${queryStringValue}";
    $(function () {
        window.pagObj = $('#pagination').twbsPagination({
            ...
            onPageClick: function (event, page) {
                if (currentPage != page) {
                    // $('#limit').val(6);
                    $('#page').val(page);
                    $('#queryString').val(queryStringValue);
                    $('#formSubmit').submit();
                }
            }
        });
