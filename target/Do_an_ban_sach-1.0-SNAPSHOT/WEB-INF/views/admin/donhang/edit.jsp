...
<c:url var="newURL" value="/quan-tri/don-hang/chi-tiet-don-hang"/>
<c:url var="editNewURL" value="/quan-tri/don-hang/chi-tiet-don-hang/chinh-sua"/>
				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" id="formSubmit" >
						<div class="form-group">
								...
								<div class="col-sm-9">
									<input  name="name" id="name" value="${model.book3.name}" cssClass="col-xs-10 col-sm-5"/>
								</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" >Sô lượng:</label>
							<div class="col-sm-9">
								<input id="amount" name="amount" value="${model.amount}" cssClass="col-xs-10 col-sm-5"/>
							</div>
						</div>

						<input type="hidden" value="${model.id}" name="id" id="newId" >
