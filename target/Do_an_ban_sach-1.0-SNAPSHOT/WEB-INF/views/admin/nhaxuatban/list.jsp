...
<div class="main-content">
    ...
    <h4 style="font-weight: bold">Quản lý nhà xuất bản</h4>
    <div class="col-xs-3">
    </div>
    <div class="col-xs-6">
        <div class="head-search">
            <input id="headSearch" type="text" placeholder="Nhập tên nhà xuất bản... ">
                            ...
                            <div class="table-btn-controls">
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <c:url var="createNewURL" value="/quan-tri/nha-xuat-ban/chinh-sua"/>
                                        <a flag="info"
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="item" items="${model.data}">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:url var="updateNewURL" value="/quan-tri/nha-xuat-ban/chinh-sua">
