...
<%--end hander--%>
	...
	<link rel="stylesheet" href="<c:url value='/template/admin/css3/style.css'/>">
...
<%--	<script src="<c:url value='/template/admin/paging/jquery.twbsPagination.min.js'/>"></script>--%>
	...
	<script src="<c:url value='/template/admin/assets/js/bootstrap.min.js'/>"></script>
	<script src="<c:url value='/template/admin/js3/chat.js' />"></script>
	<script src="<c:url value='/template/admin/js3/custom.js' />"></script>
